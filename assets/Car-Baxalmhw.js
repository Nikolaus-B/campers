import{f as ue,j as s,h as xe,u as p,r as G,g as ut,i as dt,k as ft,a as pt,b as ht,l as mt}from"./index-BnEAZob3.js";const vt=e=>e.filter.inputValue,Le=e=>e.filter.equipment,yt=e=>e.filter.type,$e=e=>e.cars.cars,bt=e=>e.cars.favourites,Ue=ue([$e,vt,Le],(e,t)=>e.filter(n=>{const{car:r}=n,a=r.name.toLowerCase(),l=r.location.toLowerCase();return a.includes(t.toLowerCase())||l.includes(t.toLowerCase())})),gt=ue([$e,Le],(e,t)=>e.filter(({car:n})=>{const{transmission:r,details:a}=n,l=[r];return Object.entries(a).forEach(([v,i])=>{i!==0&&l.push(v.toLowerCase())}),t.every(v=>l.includes(v))})),xt=ue([Ue,yt],(e,t)=>t.length===0?e:e.filter(n=>{const{car:r}=n,a=r.form.toLowerCase();return t.some(l=>a.includes(l.toLowerCase()))})),bo=ue([Ue,gt,xt],(e,t,n)=>e.filter(r=>t.includes(r)&&n.includes(r))),wt="/assets/sprite-SW9Tt7Df.svg",we=({styles:e,width:t,height:n,iconId:r})=>s.jsx(s.Fragment,{children:s.jsx("svg",{style:e,width:t,height:n,children:s.jsx("use",{href:`${wt}#${r}`})})}),Ot=xe`
  from {
    opacity: 0;
  }
  to {
